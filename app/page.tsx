...
export default function Home() {
  return (
    <main className=" mx-4  mt-24 grid h-full grid-cols-1 items-center sm:mt-16  sm:grid-cols-3">
      ...
      <div className="col-span-2 grid max-h-full grid-rows-2">
        <article className="mt-4 flex h-max w-full flex-col justify-center place-self-center rounded-md bg-white px-4 py-2 dark:bg-black sm:mt-4">
          ...
          <p className="mt-2 border-b-2 border-sky-600 pb-2">
            ...
            graduate coding in JavaScript who enjoys working in a team and
          ...
          <p className="mt-2">
            ...
            schools I've worked at, coding has gotten me excited to get out of
            bed in the mornings again. I love the constant battle between taking
            on tricky challenges and then actually finding solutions for them.
            This portfolio website is the first thing I have created since
            leaving the Northcoders course - I hope you enjoy browsing through
            the site. Please don't hesitate to get in touch if you have a great
            idea you'd like to collaborate on or if you think I'd be a good fit
            for a vacancy at your company.
          </p>
        </article>
        <FeaturedProject />
      </div>
